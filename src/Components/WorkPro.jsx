...
const WorkPro = () => {
    ...
    const data = [
        ...
        { img: { mobilephone }, step: 'Step 3', heading: 'Meet Your Accounting Manager', content: "An Innovational Accounting Manager will speak with your point of contact to discuss your business in further detail. We will also review our Onboarding Checklist with you so that we can begin sharing information and reviewing your books." },
        ...
        { img: { mobilephone }, step: 'Step 5', heading: 'Your Books Made Simple', content: "Innovational Accounting is now professionally managing your books so you don't have to. Your life just got a whole lot simpler." },
    ]
    ...
    return (
        <div className="workpro">
            ...
            <div className='workprobox'>
                {data.map((item, key) => {
                    return <div key={key} className="content">
                        <div className='workprobox1'>
